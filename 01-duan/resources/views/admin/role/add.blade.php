                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group ">
                            ...
                            <textarea rows="200" cols="200" name="display_name" id="content" placeholder="Description">{{old('display_name') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group card border-primary mb-3 col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="card-body text-primary col-md-3">
                                <h5 class="card-title">
                                    <label>
                                        <input type="checkbox" class="checkbox_childrent" name="permission_id[]" value="{{$permissionsChidrentItem->id}}">
                                    </label>
